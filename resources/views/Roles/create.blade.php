<x-app-layout>
  <div class="max-w-5xl mx-auto py-8 px-4">
    ...
    <div class="mb-6">
      <h1 class="text-base font-semibold text-gray-800">Tambah Role</h1>
      <p class="text-xs text-gray-400 mt-0.5">Isi data Role baru</p>
    </div>
    ...
    <form method="POST" action="{{ route('roles.store') }}" id="form"
      ...
      <div class="col-span-2 md:col-span-1">
        ...
        <input type="text" id="nama" name="nama" value="{{ old('nama') }}" required placeholder="Nama role"
